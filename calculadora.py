...
def TemaOscuro(*args):
    ...
    estilos_botones_borrar.map('Botones_borrar.TButton', background=['active',  '#00AB1'])
...
estilos_label1.configure('Lable1.TLabel', font="arial 15", anchor="E")

estilos_label2 = ttk.Style()
estilos_label2.configure('Lable2.TLabel', font="Arial 50", anchor="E")
...
estilos_botones_borrar.map('Botones_borrar.BTutton', foreground=[('active', '#FF0000')], background=[('active', '#858585')])
...
estilos_botones_restantes.map('Botones_restantes.BTutton', background=[('active', '#858585')])

#Botones de los numeros del 0 al 9
...
#Botones de eliminar, parentesis y el punto
